...
const Menu = () => {
  return (
    <div className={styles.menu}>
      ...
      <Level1 tabIndex={1} className={styles.line} callback={clickCallBack} onClick={clickCallBack}>
        <strong>Menu 2</strong>
      </Level1>
      <Level1 tabIndex={2} className={styles.line} callback={clickCallBack} onClick={clickCallBack}>
        <strong>Menu 3</strong>
      </Level1>
      <Level1 tabIndex={3} className={styles.line} callback={clickCallBack} onClick={clickCallBack}>
        <strong>Help</strong>
      </Level1>
    </div>
  );
