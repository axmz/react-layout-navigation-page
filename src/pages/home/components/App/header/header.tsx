...
const Header = () => {
  return (
    <Level0 tabIndex={1} className={styles.header}>
      <Level1 tabIndex={0} className={styles.hdr} callback={clickCallBack} onClick={clickCallBack}>
        <Chart />
      </Level1>
      <Level1 tabIndex={1} className={styles.hdr} callback={clickCallBack} onClick={clickCallBack}>
        <Diagram />
      </Level1>
      <Level1 tabIndex={2} className={styles.hdr} callback={clickCallBack} onClick={clickCallBack}>
        <Table />
      </Level1>
      <Level1 tabIndex={3} className={styles.hdr} callback={clickCallBack} onClick={clickCallBack}>
        <Archive />
      </Level1>
    </Level0>
  );
